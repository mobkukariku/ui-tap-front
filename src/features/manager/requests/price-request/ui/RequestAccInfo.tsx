                ...
                <div className="grid grid-cols-3 gap-4">
                    <div className="flex flex-col gap-3 p-4 bg-gradient-to-br from-primary/5 to-primary/2 rounded-xl border border-primary/10 hover:border-primary/30 transition-colors">
                        <div className="flex items-center gap-2">
                            <Building className="w-4 h-4 text-primary" />
                            <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Помещение</span>
                        </div>
                    ...
                    <div className="flex flex-col gap-3 p-4 bg-gradient-to-br from-primary/5 to-primary/2 rounded-xl border border-primary/10 hover:border-primary/30 transition-colors">
                        <div className="flex items-center gap-2">
                            <Building className="w-4 h-4 text-primary" />
                            <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Юнит</span>
                        </div>
                    ...
                    <div className="flex flex-col gap-3 p-4 bg-gradient-to-br from-primary/5 to-primary/2 rounded-xl border border-primary/10 hover:border-primary/30 transition-colors">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-semibold text-green-700 uppercase tracking-wide">Цена</span>
                        </div>
